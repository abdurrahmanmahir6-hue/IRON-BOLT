"""
providers/openai/capability.py

Capability metadata for the OpenAI provider.
Sprint 3 Task 5 (AR1 Redesign) — Phase 3 (Provider Metadata &
Capability Extraction).

Design summary
---------------
OPENAI_CAPABILITIES is the single source of truth for what the OpenAI
adapter supports. OpenAIProvider.get_capabilities() simply returns this
...
OPENAI_CAPABILITIES: tuple[ProviderCapability, ...] = (
...
"""Ordered, immutable set of capabilities supported by OpenAIProvider.
