...
class ProviderConfig:
    """
    LLM and search-provider credentials.

    All fields are Optional[SecretValue]; None means the key was not set.
    Callers check `if config.providers.openai_api_key` before use.
